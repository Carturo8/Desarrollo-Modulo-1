...
"""Escribir un programa que pida ingresar coordenadas (x, y) y determine cuántos puntos se encuentran en cada cuadrante 
(I, II, III, IV). Nota: Al inicio, el programa debe solicitar la cantidad de puntos a procesar."""
